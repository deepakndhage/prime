...
public class BluetoothSerial extends CordovaPlugin {
	...
	Log.d("dsquare-BT", " - "+Thread.currentThread().getId() +" -- starting in connect method - "+new Date());
        ...
        if (device != null) {
            ...
            result.setKeepCallback(true);
            callbackContext.sendPluginResult(result);
	    Log.d("dsquare-BT", " - "+Thread.currentThread().getId() +" -- back connect method - "+new Date());
        } else {
    ...
    private void notifyConnectionLost(String error) {
	    ...
	    Log.d("dsquare-BT", " - "+Thread.currentThread().getId() +" -- notify failure in connect method - "+new Date());
    ...
    private void notifyConnectionSuccess() {
        if (connectCallback != null) {
	    Log.d("dsquare-BT", " - "+Thread.currentThread().getId() +" -- notify success in connect method - "+new Date());
