...
(function() {
  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      function BootstrapSwitch(element, options) {
        ...
        this.options = $.extend({}, $.fn.bootstrapSwitch.defaults, {
          state: false,//this.$element.is(":checked"),
      ...
      BootstrapSwitch.prototype.state = function(value, skip) {
    		...
    		var bulbId = this.$element.attr('id');
    		var builbImg = $('#'+bulbId+'-img').attr('src');
    		var bulbIdInt=$('#'+bulbId+'-id').html();
    		var dataToSend = [123, bulbIdInt, 0, 0-bulbIdInt];
    		 if(!value && $('#'+bulbId+'-img').attr('src') && $('#'+bulbId+'-img').attr('src')=="./images/bulb-on.png"){
	        	 $('#'+bulbId+'-img').attr('src','./images/bulb-off.png');
	        	 ControllerPlugin.saveState('update', bulbIdInt, 0,0,5);
	        	 dataToSend = [123, bulbIdInt, 0, 0-bulbIdInt];
	        	// $("#companyName").html($("#companyName").html()+" - data - "+dataToSend);
	        	  
					bluetoothSerial.isConnected(
    function() {
    //	$("#companyName").html($("#companyName").html()+" - connected - ");
        ...
        /*bluetoothSerial.write(dataToSend, function(){
      	 //$("#companyName").html($("#companyName").html()+" - written 1- ");
      }, function(){
      	//$("#companyName").html($("#companyName").html()+" - failed to write 1- ");
      });*/
    },
    function() {
       //  $("#companyName").html($("#companyName").html()+" - not connected - ");
    }
);	        	 
	        	 
	        	 
	        	 //ControllerPlugin.showToast('showMessage', '5');
	         }
	         else if(value && $('#'+bulbId+'-img').attr('src') && $('#'+bulbId+'-img').attr('src')=="./images/bulb-off.png"){
	        	 $('#'+bulbId+'-img').attr('src','./images/bulb-on.png');
	        	 ControllerPlugin.saveState('update', bulbIdInt, 1,100,6);
	        	 dataToSend = [123, bulbIdInt, 100, 100-bulbIdInt];
	        	 //$("#companyName").html($("#companyName").html()+" - data - "+dataToSend);
					bluetoothSerial.isConnected(
    function() {
        bluetoothSerial.write([dataToSend[0]], function(){
       ...
       /* bluetoothSerial.write(dataToSend, function(){
      	// $("#companyName").html($("#companyName").html()+" - written 2- ");
      }, function(){
      	// $("#companyName").html($("#companyName").html()+" - failed to write 2- ");
      });*/
    },
    function() {
        // $("#companyName").html($("#companyName").html()+" - not connected - ");
	        	 ...
	        	 //ControllerPlugin.showToast('showMessage', '6');
	         }
    ...
    //duplicate function to update energy saving on UI -- Deepak
      BootstrapSwitch.prototype.calculateSaving = function(){
    	  count = 6;
	    ...
	    BootstrapSwitch.prototype.sleep = function(milliseconds) {
