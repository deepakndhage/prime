...
public class ControllerPlugin extends CordovaPlugin {
	...
	private static final String TAG = "ControllerPlugin";
	/**
	 * Constructor.
	 */
	...
	public boolean execute(final String action, JSONArray args,
		...
		if("update".equals(action)){
			...
			Log.d(TAG, "updateCurrentStateForDevice = " + value1 +" -- "+ value2 +" -- "+ value3);
			final boolean reply = updateCurrentStateForDevice(value1, value2, value3);
			Log.d(TAG, "updateCurrentStateForDevice = " + value1 +" -- "+ value2 +" -- "+ value3 +" -- "+ reply);
			/*cordova.getActivity().runOnUiThread(new Runnable() {
				public void run() {
					Toast toast = Toast.makeText(cordova.getActivity()
							.getApplicationContext(), action + " - " 
			...
			Log.d(TAG, "updateCurrentStateForDevice = " + moodJson);
			final boolean reply = saveMood(moodJson);
			Log.d(TAG, "updateCurrentStateForDevice = " + moodJson +" -- "+ reply);
			/*cordova.getActivity().runOnUiThread(new Runnable() {
				public void run() {
					Toast toast = Toast.makeText(cordova.getActivity()
							.getApplicationContext(), action + " - " 
